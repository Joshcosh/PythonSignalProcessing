...
frequency, reference = wf.read('./audio/ref_samples.wav')
...
frequency, section = wf.read('./audio/section6.wav')
...
# plt.show()
plt.savefig('./graphs/section found comparison')

print('Saving outputs...')
wf.write('./audioout/section2InReference.wav', frequency, section_in_reference)

wf.write('./audioout/filteredReference.wav', frequency, y)
